...
import 'package:synctrackr/admin/controllers/reports_visitor_list_controller.dart';
...
class ReportsVisitorList extends StatelessWidget {
  const ReportsVisitorList({super.key});

  @override
  Widget build(BuildContext context) {
    final ReportsVisitorListController controller = Get.put(ReportsVisitorListController());
